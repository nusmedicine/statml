...
locally through twenty-five review rounds and NOT PUSHED. **The spec is his
...
value each), his call after the uses were put to him. **Nothing he has
asked for is left to build.** Read
...
list in `widgets/tensors/main.js`'s header (1–39) says why each thing is
the way it is.
